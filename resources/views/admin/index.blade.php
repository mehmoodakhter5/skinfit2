@include('admin.inc.header')
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                  ...
                                  <p class="mb-0">{{count($activity)}} Total</p>
                                </div>
                                <ul class="bullet-line-list">
                                  @foreach($activity as $active)
                                  <li>
                                    <div class="d-flex justify-content-between">
                                      <div><span class="text-light-green">Ben </span> {{$active->description}}</div>
                                      <p>{{$active->created_at->diffForHumans()}}</p>
                                    </div>
                                  </li>
                                  @endforeach
  ...
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
    ...
    <span class="float-none float-sm-end d-block mt-1 mt-sm-0 text-center">Copyright © <?php echo date("Y");?>. All rights reserved.</span>
  </div>
</footer>
        <!-- partial -->
      </div>
