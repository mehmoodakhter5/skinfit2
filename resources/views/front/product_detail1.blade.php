    ...
    <div class="container">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                ...
                <div class="product1-detail-first-wrap-text3">
                    <h6>We love this item-but it’s out of stock</h6>    
                    <p>We can notify you by email when this item is back in stock</p>      
                </div>
                <div class="product1-detail-first-wrap-feild">
                ...
                <div class="product1-detail-first-wrap-btn">
                    <a href="#!">Notify Me!</a>
                </div>
            </div>
        </div>
