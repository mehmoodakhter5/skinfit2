        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="product-listing-banner-wrap-main">
                    <img src="assets/front/images/product-listingbg1.jpg" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9 col-xxl-9">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 mb-5">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        <div class="product2-wrap-img">
                            <img src="assets/front/images/product-listingbg2.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                        <div class="product2-wrap-img1">
                            <img src="assets/front/images/product2-bg2.png" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                        <div class="product2-wrap-text1">
                            <h6>Lorem Ipsum</h6>
